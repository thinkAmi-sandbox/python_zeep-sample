...
class WsiSwaRefTransport(Transport):
    """ swaRef用のTransport
    ...
    def _add_swa_header(self, headers: dict, message: bytes):
        ...
        headers["Content-Type"] = "; ".join([
            ...
            'type="text/xml"',
            'start="{}"'.format(self.soap_content_id),
            "charset=utf-8"
        ])
